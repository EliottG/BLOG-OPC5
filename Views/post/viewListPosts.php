...
<div class="container">
    <?php if (isset($_SESSION['role']) && ($_SESSION['role'][0] == 'Admin')) : ?>
        <a href="<?= htmlentities(ROOT_DIR) ?>ajouter-article"><button class="mt-3 btn btn-primary">Ajouter un article</button></a><br>
    <?php endif ?>
    <div class="row">
    <?php
    foreach ($data['posts'] as $post) : ?>
        <div class="col-xl-6">
        <a href="<?= htmlentities(ROOT_DIR) ?>article/<?= $post['ID'] ?>">
