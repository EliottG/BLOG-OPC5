...
<br>
<div class="container">
    <a href="<?= htmlentities(ROOT_DIR) ?>articles"><button class='btn btn-primary'> Revenir aux articles </button></a><br>
    ...
    <?php if (isset($_SESSION['id'])) : ?>
        <a href="<?= htmlentities(ROOT_DIR) ?>commentaire/<?= $data['post']['ID'] ?>"><button class='btn btn-dark'>Ajouter un commentaire</button></a>
        <?php endif ?>
